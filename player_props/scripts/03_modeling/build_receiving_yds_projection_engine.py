...
BACKTEST_SAFE_OUT_FILE = Path("data/analysis/reception_yds_model_bets_backtest_safe.csv")
...
def write_backtest_safe_output(bets, projections_path, markets_path, output_path):
    print("\n===== BACKTEST-SAFE RECEIVING YARDS OUTPUT =====")
    safe = bets.copy()
...
def main():
    ...
    parser.add_argument(
        ...
        help="Separate CSV path with stable season/week/game/player keys for receiving yards backtests.",
    )
