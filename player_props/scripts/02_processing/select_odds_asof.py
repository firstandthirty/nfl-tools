...
def main() -> None:
    ...
    parser.add_argument("--allow-stale-sportsbook-backfill", action="store_true", help="Opt in to legacy per-sportsbook latest selection, which can mix older sportsbook rows from different bundles.")
    ...
    print("[selection_mode]", result.get("selection_mode", ""))
